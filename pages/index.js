        ...
        <div class="max-w-6xl px-12 mx-auto bg-gray-100 md:px-16 xl:px-10">
          <div class="flex flex-col items-center lg:flex-row">
            <div class="flex flex-col items-start justify-center w-full h-full pr-8 mb-10 lg:mb-0 lg:w-1/2">
              <p class="mb-2 text-base font-medium tracking-tight text-orange-400 uppercase">
              ...
              <a
                href="#_"
                class="flex items-center justify-center px-8 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-orange-400 border border-transparent shadow hover:bg-orange-300 focus:outline-none focus:border-yellow-500 focus:shadow-yellow-NaN md:py-4 md:text-lg md:px-10 rounded-lg"
              >
                View Case Studies
              </a>
            </div>
            <div class="w-full lg:w-1/2">
              <blockquote class="flex items-center justify-between w-full col-span-1 p-6 bg-white shadow rounded-lg">
                <div class="flex flex-col pr-8">
                  <div class="relative pl-12">
                    <svg
                      class="absolute left-0 w-10 h-10 text-orange-400 fill-current"
              ...
              <blockquote class="flex items-center justify-between w-full col-span-1 p-6 mt-4 bg-white shadow rounded-lg">
      ...
      <section class="py-8 leading-7 text-gray-900 bg-white sm:py-12 md:py-16 lg:py-24">
        <div class="max-w-6xl px-10 mx-auto border-solid lg:px-12">
          <div class="flex flex-col items-start leading-7 text-gray-900 border-0 border-gray-200 lg:items-center lg:flex-row">
            ...
            <a
              href="#_"
              class="inline-flex items-center justify-center w-full px-5 py-4 mt-6 ml-0 font-sans text-base leading-none text-white no-underline bg-orange-400 border border-yellow-400 border-solid cursor-pointer md:w-auto lg:mt-0 hover:bg-yellow-500 hover:border-yellow-500 hover:text-white focus-within:bg-yellow-500 focus-within:border-yellow-500 focus-within:text-white sm:text-lg lg:ml-6 md:text-xl rounded-lg"
            >
              Get Started
              <svg
                xmlns="http://www.w3.org/2000/svg"
